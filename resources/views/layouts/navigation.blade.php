            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role == 'user' )
                        ...
                        <x-nav-link :href="route('trainer.qrscan')" :active="request()->routeIs('trainer.qrscan')">
                            {{ __('QR-Scan') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (Auth::user()->role == 'user' )
                ...
                <x-responsive-nav-link :href="route('trainer.qrscan')" :active="request()->routeIs('trainer.qrscan')">
                    {{ __('QR-Scan') }}
                </x-responsive-nav-link>
            @else
